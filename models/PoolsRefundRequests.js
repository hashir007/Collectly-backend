...
module.exports = (sequelize, DataTypes) => {
  class PoolsRefundRequests extends Model {
    /**
    ...
    static associate(models) {
      ...
      PoolsRefundRequests.belongsTo(models.User, {
        foreignKey: "createdBy"
      });
      PoolsRefundRequests.belongsTo(models.Pools, {
        foreignKey: "poolID"
      });
    }
  }
  PoolsRefundRequests.init({
    id: {
      allowNull: false,
      autoIncrement: true,
      primaryKey: true,
    ...
    hooks: {
      afterCreate: function (model, options) {
        ...
        var auditLog = sequelize.models.EventLog.build({
          ...
          table_name: "pools_refund_requests",
    ...
    sequelize,
    modelName: 'PoolsRefundRequests',
    freezeTableName: true,
    tableName: 'pools_refund_requests'
  });
  return PoolsRefundRequests;
};