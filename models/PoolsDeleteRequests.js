...
module.exports = (sequelize, DataTypes) => {
  class PoolsDeleteRequests extends Model {
    /**
    ...
    static associate(models) {
      ...
      PoolsDeleteRequests.belongsTo(models.Pools,{
        foreignKey: "poolID"
      }); 

      PoolsDeleteRequests.belongsTo(models.User,{
        foreignKey: "createdBy"
      }); 

    }
  }
  PoolsDeleteRequests.init({
    id: {
      allowNull: false,
      autoIncrement: true,
      primaryKey: true,
    ...
    hooks: {
      afterCreate: function (model, options) {
        ...
        var auditLog = sequelize.models.EventLog.build({
          ...
          table_name: "pools_delete_requests",
    ...
    sequelize,
    modelName: 'PoolsDeleteRequests',
    freezeTableName: true,
    tableName: 'pools_delete_requests'
  });
  return PoolsDeleteRequests;
};