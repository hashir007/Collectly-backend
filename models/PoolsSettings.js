...
module.exports = (sequelize, DataTypes) => {
  class PoolsSettings extends Model {
    /**
    ...
    static associate(models) {
      ...
      PoolsSettings.belongsTo(models.Pools,{
        foreignKey: "poolID",
        as:'pool'
      }); 
    }
  ...
  PoolsSettings.init({
    ...
    sequelize,
    modelName: 'PoolsSettings',
    freezeTableName: true,
    tableName: 'pools_settings'
  });
  return PoolsSettings;
};